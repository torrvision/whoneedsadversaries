%% 
% Modified from original DeepFool source at
%   https://github.com/LTS4/DeepFool.
% See comments in adversarial_ProjectedDeepFool_matconvnet.m
...
% SJ/NL: returning adversarial "confidences"
adv_out = f_out(x+(1+OS)*r,0);
[adv.new_conf, adv.new_label] = max(adv_out);
